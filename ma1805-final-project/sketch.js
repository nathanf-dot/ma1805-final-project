...
function preload() {
  windsound = loadSound("assets/whoosh01.mp3"); // I made this sound simply by just blowing into my phone microphone
  //  to create an original asset as originally I was going to use an audio off the website freesounds //
}
...
if (rippleActive) {
  ...
  noFill();
  stroke(255, 255, 255, 180); // white ring signifies the effect of the harsher wind on the trees //
  strokeWeight(2);
